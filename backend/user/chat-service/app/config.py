...
NEO4J_URI_CHATS = os.getenv('NEO4J_URI_CHATS')
NEO4J_USERNAME_CHATS = os.getenv('NEO4J_USERNAME_CHATS')
NEO4J_PASSWORD_CHATS= os.getenv('NEO4J_PASSWORD_CHATS')
NEO4J_DATABASE_CHATS= os.getenv('NEO4J_DATABASE_CHATS')
